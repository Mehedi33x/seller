        ...
        <div class="cat-blocks-container">
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="{{route('laptop')}}" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/1.png')}}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/2.png')}}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/3.png')}}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/4.png')}}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/5.png')}}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{url('frontend/assets/images/demos/demo-4/cats/6.png')}}" alt="Category image">
                            </span>
                        </figure>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{url('frontend/assets/images/demos/demo-4/banners/banner-1.png')}}" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{url('frontend/assets/images/demos/demo-4/banners/banner-2.jpg')}}" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{url('frontend/assets/images/demos/demo-4/banners/banner-3.png')}}" alt="Banner">
                    </a>
                ...
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{url('frontend/assets/images/demos/demo-4/products/product-1.jpg')}}" alt="Product image" class="product-image">
                            </a>
