                                ...
                                <div class="col-md-6">
                                    <div class="product-gallery product-gallery-separated">
                                        ...
                                        <figure class="product-separated-item">
                                            <img src="{{url('frontend/assets/images/products/single/sticky/1.jpg')}}" data-zoom-image="{{url('frontend/assets/images/products/single/sticky/1-big.jpg')}}" alt="product image">
                                        ...
                                        <figure class="product-separated-item">
                                            <img src="{{url('frontend/assets/images/products/single/sticky/2.jpg')}}" data-zoom-image="assets/images/products/single/sticky/2-big.jpg" alt="product image">
                                        </figure>
    
                                        <figure class="product-separated-item">
                                            <img src="{{url('frontend/assets/images/products/single/sticky/3.jpg')}}" data-zoom-image="assets/images/products/single/sticky/3-big.jpg" alt="product image">
                                        </figure>
    
                                        <figure class="product-separated-item">
                                            <img src="{{url('frontend/assets/images/products/single/sticky/4.jpg')}}" data-zoom-image="assets/images/products/single/sticky/4-big.jpg" alt="product image">
                                        </figure>
