        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="index.html" class="logo">
                    <img src="{{url('frontend/assets/images/demos/demo-4/logo.png')}}" alt="Molla Logo" width="105" height="25">
                </a>
            </div><!-- End .header-left -->
                    ...
                    <div class="dropdown-menu">
                        <nav class="side-nav">
                            <ul class="menu-vertical sf-arrows">
                                <li>
                                    <a href="#" class="sf-with-ul">Smartphones</a>
                                    <ul>
                                        <li><a href="login.html">Apple</a></li>
                                        <li><a href="login.html">Samsung</a></li>
                                        <li><a href="login.html">Xiaomi</a></li>
                                        <li><a href="login.html">Redmi</a></li>
                                        <li><a href="login.html">Realme</a></li>
                                        <li><a href="login.html">Oppo</a></li>
                                        <li><a href="login.html">Oneplus</a></li>
                                        <li><a href="login.html">Motorala</a></li>
                                        <li><a href="login.html">Vivo</a></li>
                                        <li><a href="login.html">Nokia</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="blog.html" class="sf-with-ul">Accessories</a>
                                    <ul>
                                        <li><a href="blog.html">Speaker</a></li>
                                        <li><a href="blog.html">Power Bank</a></li>
                                        <li><a href="blog.html">Fitness Band</a></li>
                                        <li><a href="blog.html">Fitness Band</a></li>
                                        <li><a href="blog-listing.html">Smart Watch</a></li>  
                                    </ul>
                                </li>
        
                                <li>
                                    <a href="blog.html" class="sf-with-ul">Laptop</a>
                                    <ul>
                                ...
                                <li>
                                    <a href="blog.html" class="sf-with-ul">Camera</a>
                                ...
                                <li>
                                    <a href="blog.html" class="sf-with-ul">Video Games</a>
